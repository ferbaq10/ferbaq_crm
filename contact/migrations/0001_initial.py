    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='catalog.city', verbose_name='Ciudad')),
                ('contact', models.ManyToManyField(blank=True, related_name='clients', to='client.client', verbose_name='Contactos')),
            ],
            options={
